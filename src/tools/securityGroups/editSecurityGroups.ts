...
type EditSecurityGroupToolHandler = (args: EditSecurityGroupArgs, extra: RequestHandlerExtra<ServerRequest, ServerNotification>) => Promise<{
    content: { type: "text"; text: string; }[];
}>;


export const editSecurityGroup: EditSecurityGroupToolHandler = async (args, extra) => {
