...
type DeleteEC2InstanceToolHandler = (args: DeleteEC2InstanceArgs, extra: RequestHandlerExtra<ServerRequest, ServerNotification>) => Promise<{
    content: { type: "text"; text: string; }[];
}>;

export const deleteEC2Instance: DeleteEC2InstanceToolHandler = async (args, extra) => {
