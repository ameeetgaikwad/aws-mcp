...
export const createEC2InstanceInteractive: ToolHandler = async (
  args,
  extra,
) => {
  try {
          ...
          text: JSON.stringify(
            {
              status: "info",
              message:
                "To create an EC2 instance, please provide the following required parameters:\n" +
...
export const createEC2InstanceWithParams: EC2ToolHandler = async (
  args,
  extra,
) => {
  try {
